      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <GlassCard variant="strong" className="p-8 glow-purple animate-slide-up">
          <h1 className="text-3xl font-bold text-starlight mb-2 text-center" style={{fontFamily: 'var(--font-display)'}}>
            ثبت نام در AstroTunes
          </h1>
          <p className="text-muted text-center mb-8">
            سفر خود در کهکشان موسیقی را شروع کنید
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="confirmPassword" className="block text-starlight font-medium mb-2">
                تکرار رمز عبور
              </label>
              <input
                type="password"
            ...
            <div className="flex items-start">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-white/20 bg-white/10 text-nebula focus:ring-nebula"
                required
              />
              <label htmlFor="terms" className="mr-2 text-muted text-sm">
                <Link href="/terms" className="text-nebula hover:text-nebula-purple-light">قوانین و مقررات</Link> و <Link href="/privacy" className="text-nebula hover:text-nebula-purple-light">حریم خصوصی</Link> را می‌پذیرم
              </label>
            </div>
          ...
          <p className="text-center text-muted mt-6">
            حساب کاربری دارید؟{' '}
            <Link href="/login" className="text-nebula hover:text-nebula-purple-light font-medium">
              ورود
            </Link>
          </p>
        </GlassCard>
